...
public interface VehicleMapper {
    ...
    default BookingResponseDTO mapToBookingResponseDTO(Booking booking) {
        ...
        BookingResponseDTO dto = BookingResponseDTO.builder()
                ...
                .timeTransaction(booking.getTimeTransaction())
                .totalCost(booking.getTotalCost())
                .status(booking.getStatus())
                .penaltyType(booking.getPenaltyType() != null ? booking.getPenaltyType().name() : null)
                .penaltyValue(booking.getPenaltyValue())
                .minCancelHour(booking.getMinCancelHour())
