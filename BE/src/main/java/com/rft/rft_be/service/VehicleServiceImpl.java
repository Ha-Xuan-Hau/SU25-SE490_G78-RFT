...
import com.rft.rft_be.dto.UpdateVehicleDTO;
import com.rft.rft_be.dto.VehicleDTO;
import com.rft.rft_be.entity.*;
import com.rft.rft_be.exception.VehicleDeletionException;
import com.rft.rft_be.exception.VehicleNotFoundException;
...
public class VehicleServiceImpl implements VehicleService {
    ...
    public VehicleDTO updateVehicle(String id, VehicleDTO vehicleDTO) {
        ...
        if (vehicleDTO.getVehicleTypes() != null) {
            existingVehicle.setVehicleTypes(vehicleDTO.getVehicleTypes());
        }
        ...
        if (vehicleDTO.getStatus() != null) {
            try {
                ...
                throw new RuntimeException("Invalid status value: " + vehicleDTO.getStatus());
            }
        }
        ...
        if (vehicleDTO.getTransmission() != null) {
            try {
                ...
                throw new RuntimeException("Invalid transmission value: " + vehicleDTO.getTransmission());
            }
        }
        if (vehicleDTO.getFuelType() != null) {
            try {
                ...
                throw new RuntimeException("Invalid fuel type value: " + vehicleDTO.getFuelType());
            }
        }
    ...
    public VehicleDTO createVehicle(CreateVehicleDTO createVehicleDTO) {
        ...
        Vehicle vehicle = Vehicle.builder()
                ...
                .vehicleTypes(createVehicleDTO.getVehicleTypes())
